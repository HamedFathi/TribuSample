...
public static class ResultExtensions
{
    ...
    public static IActionResult ToActionResult(this TheResult.Result result)
    {
    ...
    public static IResult ToMinimalApiResult(this TheResult.Result result)
    {
        return result.Status switch
        {
    ...
    public static ProblemDetails? ToProblemDetails(this TheResult.Result result)
    {
        return result.Status switch
        {
    ...
    public static IActionResult ToActionResult(this TheResult.Result result, HttpStatusCode statusCode)
    {
    ...
    /// <returns>An IActionResult representing a Created response.</returns>
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IActionResult ToCreatedResult(this TheResult.Result result, string location)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    /// <returns>An IResult representing a Created response.</returns>
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IResult ToCreatedMinimalApiResult(this TheResult.Result result, string location)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IActionResult ToAcceptedResult(this TheResult.Result result, string location)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IResult ToAcceptedMinimalApiResult(this TheResult.Result result, string location)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    public static IActionResult ToBadRequestResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Failure or ValidationError.</exception>
    public static IResult ToBadRequestMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Failure && result.Status != ResultStatus.ValidationError)
        {
            throw new ArgumentException("Result must have a status of Failure or ValidationError.");
    ...
    public static IActionResult ToUnauthorizedResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Unauthorized.</exception>
    public static IResult ToUnauthorizedMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Unauthorized)
        {
            throw new ArgumentException("Result must have a status of Unauthorized.");
    ...
    public static IActionResult ToForbiddenResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Forbidden.</exception>
    public static IResult ToForbiddenMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Forbidden)
        {
            throw new ArgumentException("Result must have a status of Forbidden.");
    ...
    public static IActionResult ToNotFoundResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not NotFound.</exception>
    public static IResult ToNotFoundMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.NotFound)
        {
            throw new ArgumentException("Result must have a status of NotFound.");
    ...
    public static IActionResult ToConflictResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Conflict.</exception>
    public static IResult ToConflictMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Conflict)
        {
            throw new ArgumentException("Result must have a status of Conflict.");
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IActionResult ToOkResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IResult ToOkMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    public static IActionResult ToUnsupportedResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Unsupported.</exception>
    public static IResult ToUnsupportedMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Unsupported)
        {
            throw new ArgumentException("Result must have a status of Unsupported.");
    ...
    public static IActionResult ToUnavailableResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Unavailable.</exception>
    public static IResult ToUnavailableMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Unavailable)
        {
            throw new ArgumentException("Result must have a status of Unavailable.");
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IActionResult ToNoContentResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not Success.</exception>
    public static IResult ToNoContentMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.Success)
        {
            throw new ArgumentException("Result must have a status of success.");
    ...
    public static IActionResult ToCriticalErrorResult(this TheResult.Result result)
    {
    ...
    /// <exception cref="ArgumentException">Thrown if the result status is not CriticalError.</exception>
    public static IResult ToCriticalErrorMinimalApiResult(this TheResult.Result result)
    {
        if (result.Status != ResultStatus.CriticalError)
        {
            throw new ArgumentException("Result must have a status of CriticalError.");
