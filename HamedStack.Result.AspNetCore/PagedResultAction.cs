...
/// <summary>
/// Represents an action result wrapper for a <see cref="PagedResult{T}"/> object.
/// </summary>
/// <typeparam name="T">The type of the data contained in the result.</typeparam>
public class PagedResultAction<T> : ActionResult
{
    /// <summary>
    ...
    public PagedResultAction(PagedResult<T> result)
    {
        Result = result;
    }
