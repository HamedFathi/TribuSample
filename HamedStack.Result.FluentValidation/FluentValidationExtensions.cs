...
public static class FluentValidationExtensions
{
    ...
    public static TheResult.Result ToResult(this ValidationResult validationResult, string successMessage = "")
    {
        if (validationResult.IsValid)
            return TheResult.Result.Success(successMessage);
        ...
        return TheResult.Result.ValidationError(errors);
    }
